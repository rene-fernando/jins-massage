        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { title: "Himalayan Salt Stone", desc: "Warm salt stones to soothe tight areas and provide a natural detoxifying effect.", price: "$15", image: "images/himalayanStone.jpg" },
